...
struct StellarFeatureProbeRowV064 {
  ...
  double weighted_screen_abs_y_q90;
  double weighted_screen_abs_y_q95;
  double weighted_screen_abs_y_q99;
  double weighted_screen_half_extent_q90;
  double weighted_screen_half_extent_q95;
  double weighted_screen_half_extent_q99;
  double weighted_radius_over_disk_radius_q90;
  double weighted_radius_over_disk_radius_q95;
  double weighted_radius_over_disk_radius_q99;
  double weighted_absolute_height_over_polar_outer_q90;
  double weighted_absolute_height_over_polar_outer_q95;
  double weighted_absolute_height_over_polar_outer_q99;
  double weighted_signed_height_center_over_polar_outer;
  bool touches_left;
  bool touches_right;
  bool touches_bottom;
  bool touches_top;
