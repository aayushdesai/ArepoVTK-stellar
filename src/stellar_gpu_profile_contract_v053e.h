#ifndef AREPO_VTK_STELLAR_GPU_PROFILE_CONTRACT_V053E_H
#define AREPO_VTK_STELLAR_GPU_PROFILE_CONTRACT_V053E_H

#include "stellar_gpu_profile_contract_v053d.h"
#include "stellar_physical_optical_v074.h"

inline bool stellarGpuProfileContractValidV053e(
