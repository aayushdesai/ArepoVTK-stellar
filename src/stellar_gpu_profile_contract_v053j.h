#ifndef AREPO_VTK_STELLAR_GPU_PROFILE_CONTRACT_V053J_H
#define AREPO_VTK_STELLAR_GPU_PROFILE_CONTRACT_V053J_H

#include "stellar_gpu_profile_contract_v053h.h"
#include "stellar_hero_projection_v080.h"

inline bool stellarGpuProfileContractValidV053j(
    int render_program, int transfer_mode, int palette_profile,
    int feature_profile, int physical_optical_profile)
{
  if(render_program == STELLAR_RENDER_PROGRAM_RETAINED_V078_V080)
