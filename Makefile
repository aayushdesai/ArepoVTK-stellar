...
HEAD = ArepoRT.h camera.h fileio.h fileio_img.h geometry.h integrator.h keyframe.h renderer.h sampler.h spectrum.h stellar_camera_path_v055.h stellar_camera_v054.h stellar_feature_profile_v065.h stellar_palette_v057.h transfer.h transform.h util.h volume.h snapio.h
...
stellar_feature_probe_v064: src/stellar_feature_probe_v064.cpp src/stellar_feature_diagnostics_v064.cpp src/stellar_feature_diagnostics_v064.h src/stellar_gpu_scene_format_v052.h src/stellar_render_model_v052a.h src/stellar_feature_profile_v065.h src/stellar_palette_v057.h
	$(CC) $(CFLAGS) -Isrc src/stellar_feature_diagnostics_v064.cpp src/stellar_feature_probe_v064.cpp -o $@

test_stellar_feature_diagnostics_v064: tests/test_stellar_feature_diagnostics_v064.cpp src/stellar_feature_diagnostics_v064.cpp src/stellar_feature_diagnostics_v064.h src/stellar_gpu_scene_format_v052.h src/stellar_render_model_v052a.h src/stellar_feature_profile_v065.h src/stellar_palette_v057.h
	$(CC) $(CFLAGS) -Isrc src/stellar_feature_diagnostics_v064.cpp tests/test_stellar_feature_diagnostics_v064.cpp -o $@
...
clean:
	+$(MAKE) -C arepo clean
	rm -f $(OBJS) $(EXECNAME) stellar_camera_director_v056 stellar_camera_director_v059 stellar_camera_director_v060 stellar_camera_director_v061 stellar_camera_director_v062 stellar_camera_director_v063 stellar_feature_probe_v064 test_stellar_cinematic_director_v059 test_stellar_cinematic_director_v060 test_stellar_cinematic_director_v061 test_stellar_cinematic_director_v062 test_stellar_cinematic_director_v063 test_stellar_palette_v057 test_stellar_palette_v058 test_stellar_feature_diagnostics_v064 test_stellar_feature_profile_v065 $(MISC_RM)
