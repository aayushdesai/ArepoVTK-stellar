...
int main()
{
  assert(stellarGpuProfileContractValidV053j(
      STELLAR_RENDER_PROGRAM_RETAINED_V078_V080,
  ...
  assert(!stellarGpuProfileContractValidV053j(
      ...
      STELLAR_FEATURE_STRUCTURES_V065,
      STELLAR_PHYSICAL_OPTICAL_COMPOSITE_MOMENT_V078));
  std::cout << "STELLAR_GPU_PHYSICAL_CONTRACT_V053J_OK "
            << "retained=v053h hero=hero_projected_copper_blue_v080\n";
  return 0;
}
